...
<p className="aboutus-companydesc">(2) you will maintain the accuracy of such information and promptly update such registration information as necessary; </p>
<p className="aboutus-companydesc">If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the right to suspend or terminate your account 
                                   and refuse any and all current or future use of the Site (or any portion thereof). </p>
<h1 className="aboutus-header">USER REGISTRATION</h1>  
<p className="aboutus-companydesc">You may be required to register with the Site. You agree to keep your password confidential and will be responsible for all use of your account and password.
                                    We reserve the right to remove, reclaim, or change a username you select if we determine,
                                    in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.</p><br/>
<h1 className="aboutus-header">PRODUCTS</h1> 
...
Access to delivery area </p>
<p className="aboutus-companydesc">•Incomplete address indicated by customer or no one to receive the order </p>
<h1 className="aboutus-header">RETURN/REFUNDS POLICY</h1> 
<p className="aboutus-companydesc">
All sales are final and no refund will be issued. Please review our Return Policy posted on the Site prior to making any purchases. </p><br/>
<h1 className="aboutus-header">UPDATING OUR TERMS</h1> 
<p className="aboutus-companydesc">
We reserve the right to revise and amend these Terms from time to time and changes will take effect immediately.
 You will be subject to the policies and terms in force at the time that you order products from us, unless any change to those Policies, Terms or Privacy Policy is required to be made by law or governmental authority. </p><br/>
<h1 className="aboutus-header">
GOVERNING LAW</h1> 
<p className="aboutus-companydesc">Contracts for the purchase of products through our site will be governed by Philippine law. Any dispute arising from, or related to, such Contracts shall be subject to the jurisdiction of Philippine courts. </p><br/>
    </div>
    </div>
)
}